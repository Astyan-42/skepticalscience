...
from publications.views import PublicationCreate, download, PublicationTableView, PublicationReviewTableView
...
urlpatterns = [url(r'^new_publication/$', PublicationCreate.as_view(), name="create_publication"),
               ...
               url(r'^publication_review/$', PublicationReviewTableView.as_view(),name="publication_review")
]
