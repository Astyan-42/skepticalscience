...
from custompayment.views import details, payment_choice, start_payment, BillingAddressUpdate, DiscountOrderUpdate

urlpatterns = [
    url(r'^(?P<token>[-\w]+)/$', details, name='detail_order'),
